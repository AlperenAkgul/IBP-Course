        ...
        <div class="row justify-content-center">
            <div class="col-md-9">
                <div class="card card-primary card-outline">
                    ...
                    <a href="<?= base_url() ?>messages/send" class="btn btn-primary btn-block mb-3">Send Message to Admin</a>
                                    ...
                                    ?>
                                        <tr class="rows" id="parent">
                                            ...
                                            <td class="project-actions text-right">
                                                <a class="btn btn-primary btn-sm" href="<?= base_url() ?>messages/read/<?= $rs->id ?>">
