  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-primary navbar-dark">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="<?= base_url() ?>admin/stock" class="nav-link">Stock</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <a href="<?= base_url() ?>admin/announcements" class="nav-link">Announcements</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <a href="<?= base_url() ?>admin/messages" class="nav-link">Messages</a>
        </li>
      </ul>
    </nav>
    <!-- /.navbar -->